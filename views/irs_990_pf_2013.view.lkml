view: irs_990_pf_2013 {
  sql_table_name: `finance_data.irs_990_pf_2013`
    ;;
  ...
  dimension: acqdrindrintcd {
    type: string
    description: "Acquire interest in applicable insurance contract question"
    sql: ${TABLE}.acqdrindrintcd ;;
  }

  dimension: actnotpr {
    type: string
    description: "Activities not previously reported question"
    sql: ${TABLE}.actnotpr ;;
  }
  ...
  dimension: applyprovind {
    type: string
    description: "Not applying section 4942(a)(2) provisions question"
  ...
  dimension: chgnprvrptcd {
    type: string
    description: "Changes not previously reported question"
  ...
  dimension: cntrbtrstxyrcd {
    type: string
    description: "Substantial contributors question"
  ...
  dimension: exceptactsind {
    type: string
    description: "Acts fail to qualify under section 53.4941(d)-3 question"
    sql: ${TABLE}.exceptactsind ;;
  }

  dimension: excesshldcd {
    type: string
    description: "Excess business holdings question"
  ...
  dimension: excptransind {
    type: string
    description: "Transactions fail to qualify under section 53.4945 question"
  ...
  dimension: filedf990tcd {
    type: string
    description: "Filed 990-T question"
    sql: ${TABLE}.filedf990tcd ;;
  }

  dimension: filedlf1041ind {
    type: string
    description: "Section 4947(a)(1) filing in lieu of Form 1041 question"
  ...
  dimension: furnishcpycd {
    type: string
    description: "Furnished copy to Attorney General question"
  ...
  dimension: loansguarcd {
    type: string
    description: "Loans or other guarantees question"
  ...
  dimension: orgcmplypubcd {
    type: string
    description: "Comply with public inspection question"
  ...
  dimension: perfservicescd {
    type: string
    description: "Performance of services or membership or fundraising solicitations question"
    sql: ${TABLE}.perfservicescd ;;
  }

  dimension: prchsasstscd {
    type: string
    description: "Purchase of assets from noncharitable exempt organization question"
    sql: ${TABLE}.prchsasstscd ;;
  }

  dimension: prevjexmptcd {
    type: string
    description: "Prior year jeopardizing investments question"
  ...
  dimension: prioractvcd {
    type: string
    description: "Engage in acts in prior year question"
  ...
  dimension: pyprsnlbnftind {
    type: string
    description: "Pay premiums on personal benefit contract question"
  ...
  dimension: reimbrsmntscd {
    type: string
    description: "Reimbursements arrangements question"
    sql: ${TABLE}.reimbrsmntscd ;;
  }

  dimension: rentlsfacltscd {
    type: string
    description: "Rental of facilities or other assets question"
    sql: ${TABLE}.rentlsfacltscd ;;
  }

  dimension: rfprsnlbnftind {
    type: string
    description: "Receive funds to pay premiums on personal benefit contract question"
    sql: ${TABLE}.rfprsnlbnftind ;;
  }

  dimension: salesasstscd {
    type: string
    description: "Sale of assets to noncharitable exempt organization question"
  ...
  dimension: sharngasstscd {
    type: string
    description: "Sharing of facilities, equipment, mailing lists, other assets, or paid employees question"
  ...
  dimension: trnsfrcashcd {
    type: string
    description: "Transfer cash to noncharitable exempt organization question"
    sql: ${TABLE}.trnsfrcashcd ;;
  }

  dimension: trnsothasstscd {
    type: string
    description: "Transfer other assets to noncharitable exempt organization question"
